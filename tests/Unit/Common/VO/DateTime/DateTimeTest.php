...
final class DateTimeTest extends TestCase
{
    ...
    public function testCreateDateTime(): void
    {
        ...
        $dateTime = DateTime::ofWithTimezone(new \DateTime('2024-06-18'), new \DateTimeZone('Europe/Paris'));
        self::assertEquals('Europe/Paris', $dateTime->toDateTime()->getTimezone()->getName());

        $dateTime = DateTime::ofWithTimezone(1719743137, new \DateTimeZone('Europe/Paris'));
        self::assertEquals('Europe/Paris', $dateTime->toDateTime()->getTimezone()->getName());

        $dateTime = DateTime::of('2024-06-18');
        $newDateTime = DateTime::ofWithTimezone($dateTime, new \DateTimeZone('Europe/Paris'));
